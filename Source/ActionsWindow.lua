...
function ActionsWindow.InitActionData()
	...
	ActionsWindow.ActionData[5723] = { type=SystemData.UserAction.TYPE_SPEECH_USER_COMMAND,			inActionWindow=true, iconId=875102, detailTid=1115919, nameTid=1115918,  callback=L"script Actions.IgnoreActionSelf()" }
	...
	ActionsWindow.Groups[16] = { nameString=L"Menu Actions",			nameTid=1154979, index={ 5001, 5002, 5003, 5004, 5005, 5006, 89, 5007, 88, 5008, 5009, 5010, 5011, 5012, 5013, 3, 5014, 5015, 5016 } }
