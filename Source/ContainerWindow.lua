...
function ContainerWindow.Initialize()
	...
	ContainerWindow.OpenContainers[id] = {open = true, cascading = false, slotsWide = 0, slotsHigh = 0, dirty=0}	
	...
	if (WindowData.ContainerWindow[id].maxSlots > ContainerWindow.MAX_BANK_SLOTS and ContainerWindow.ViewModes[id] ~= "Freeform") then
	...
	if (not Interface.GridLegacy ) then
		...
		if ( gumpID == 60 ) then
			...
			if (ContainerWindow.PlayerBackpack == id ) then
				WindowClearAnchors(this.."Lock")
				WindowSetShowing(this.."Lock", true)
				WindowAddAnchor( this.."Lock", "top", this, "center", 10, 60)
				WindowSetMovable(this,not ContainerWindow.Locked )
				WindowClearAnchors(this.."Organize")
				WindowAddAnchor( this.."Organize", "topleft", this.."Search", "topleft", -40, 0)
				WindowClearAnchors(this.."Restock")
				WindowAddAnchor( this.."Restock", "topright", this.."Organize", "topright", -40, 0)
				WindowClearAnchors(this.."Search")
				WindowAddAnchor( this.."Search", "topright", this.."ViewButton", "topright", 45, 30)
				WindowSetShowing(this.."Organize", true)
				WindowSetShowing(this.."Restock", true)
			end
		...
		if ( gumpID == 289 ) then
			...
			WindowClearAnchors(this.."ListView")
			WindowClearAnchors(this.."ViewButton")
			WindowAddAnchor( this.."ViewButton", "bottom", this, "center", 20, -80)
		...
		if ( gumpID == 1422 ) then
			...
			WindowClearAnchors(this.."Organize")
			WindowAddAnchor( this.."Organize", "topright", this.."ViewButton", "topright", 48, -5)
			WindowClearAnchors(this.."Search")
			WindowAddAnchor( this.."Search", "topright", this.."Organize", "topleft", 8, 0)
			WindowClearAnchors(this.."Restock")
			WindowAddAnchor( this.."Restock", "topleft", this.."ViewButton", "topleft", -53, -5)
			WindowClearAnchors(this.."LootAll")
		...
		if (ContainerWindow.PlayerBackpack ~= id and gumpID ~= 1422) then
				WindowClearAnchors(this.."Organize")
				WindowAddAnchor( this.."Organize", "topright", this.."ViewButton", "topright", 38, -5)
				WindowClearAnchors(this.."Search")
				WindowAddAnchor( this.."Search", "topright", this.."Organize", "topright", 30, 0)
				WindowClearAnchors(this.."Restock")
				WindowAddAnchor( this.."Restock", "topleft", this.."ViewButton", "topleft", -38, -5)
				WindowClearAnchors(this.."LootAll")
				WindowAddAnchor( this.."LootAll", "topleft", this.."Restock", "topright", 0, 0)
				WindowClearAnchors(this.."Content")
				WindowAddAnchor( this.."Content", "bottom", this, "top", 5, 5)
...
function ContainerWindow.UpdateContents(id,forceUpdate)
	--Debug.Print("ContainerWindow.UpdateContent")	
	this = "ContainerWindow_"..id
