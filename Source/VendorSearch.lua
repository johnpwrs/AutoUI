...
function VendorSearch.UpdateButtonsMap() 
	...
	VendorSearch.MiscellaneousButtons = {
		...
		[15] = { buttonId = VendorSearch.TotalCriteria + MiscOffset + 15, buttonText = "enhance potions", tid = 1075624, textboxId = 27};
		[16] = { buttonId = VendorSearch.TotalCriteria + MiscOffset + 16, buttonText = "lower requirements", tid = 1062753, textboxId = 28};
		[17] = { buttonId = VendorSearch.TotalCriteria + MiscOffset + 17, buttonText = "luck", tid = 1061153, textboxId = 29};
		[18] = { buttonId = VendorSearch.TotalCriteria + MiscOffset + 18, buttonText = "reflect physical damage", tid = 1062738, textboxId = 30};
		[19] = { buttonId = VendorSearch.TotalCriteria + MiscOffset + 19, buttonText = "self repair", tid = 1079709, textboxId = 31};
		[20] = { buttonId = VendorSearch.TotalCriteria + MiscOffset + 20, buttonText = "artifact rarity", tid = 1154693, textboxId = 32};
	}
	
	local DamageTypeOffset = 95
